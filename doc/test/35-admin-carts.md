...
```bash
curl -i -X GET "$BASE_URL/api/v1/admin/carts" --get \
...
Includes approved, pending, rejected, and disabled-owner carts. No search/status filter is implemented on this path.
